...
comp= False
compare = False
pathname2 = 'results-final-4/results-sd/'
value2 = 1.2
steps2 = 499
...
def plot_error_bars(x,data,num_runs,color):
	...
	plt.fill_between(x,(mean+std/int(np.sqrt(num_runs))),(mean-std/int(np.sqrt(num_runs))),alpha=0.2,color=color)
...
if dataset == 'cycleworld':
	bptt_pathname = 'results-iclr/results-cw/'
	pathname = 'results-iclr/results-cw/'
	learning_rate = 0.01
	fpt_lr = 0.01
	output_lr = 0.01
	...
	if cycleworld_size == 6:
		baseline = 17*np.ones_like(x)
	elif cycleworld_size == 10:
		baseline = 10*np.ones_like(x)
	time_steps_series = []
	configs = []
	...
	bptt_pathname = 'results-iclr/results-sd/'
	pathname = 'results-iclr/results-sd/'
	data_name = 'sd_'
...
for time_steps in time_steps_series:
	...
	# bptt_mean = bptt[run]
	if dataset != 'ptb':
		if buffer == True or compare==True:
			pass
		else:
...
# lines = ax.plot(data)
if compare==True:
	ax.legend(custom_lines, ['Random-FPP', 'FPP'],frameon=False)
else:
	ax.legend(custom_lines, [name, 'FPP'],frameon=False)
...
configs = [(100,1,0),(100,3,0),(100,5,0),(100,10,0),(100,15,0),(100,50,0),(1000,1,0),(1000,3,0),(1000,5,0),(1000,10,0),(1000,15,0),(1000,50,0),(10000,1,0),(10000,3,0),(10000,5,0),(10000,10,0),(10000,15,0),(10000,50,0)]
