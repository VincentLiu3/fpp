...
if dataset == 'cycleworld':
	...
	pathname = 'results-iclr-lr/results-cw/'
	lr = [0.001,0.003,0.01,0.03,0.01,0.03]
	learning_rate = 0.01
	fpt_lr = 0.01
	output_lr = 0.01
	...
	pathname = 'results-iclr-lr/results-sd/'
...
if dataset == 'stochastic_dataset':
	x = ['0.0001','0.0003','0.001','0.003','0.01']
elif dataset == 'cycleworld':
	x = ['0.001','0.003','0.01','0.03','0.1','0.3']
# if hybrid == True:
...
for time_steps in time_steps_series:
	...
	for i in range(len(lr)):
		filename_bptt = bptt_pathname+'bptt/'+data_name+'lr_{}_bptt_T_{}'.format(lr[i], time_steps)+end_name_bptt
	...
	for i in range(len(lr)):
		...
		if hybrid == True:
			...
			if exp == True:
				...
				folder = ''
				end_name = end_name_fpt
			filename_fpt = pathname+'hybrid/'+folder+data_name+'lr_{}{}_lamb_{}_fpt_n_{}_N_{}_s_{}_a{}{}'.format(lr[i],lr[i],1.0,buffer_length,
