...
class FPT_Model:
    def __init__(self, dataset, use_lstm, n_input, n_classes, num_units, num_trajectory, batch_size, sample_updates,
        ...
        self.x_t = tf.placeholder(tf.float32, [self.sample_updates, None, 1, self.n_input], name='Input0')
        ...
        self.input_t_seq = tf.unstack(self.x_new_seq, self.sample_updates, axis=0)  # (M, T, batch_size, n_inpu)
